<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Templates/Template001/default.master" AutoEventWireup="true" CodeFile="range.aspx.cs" Inherits="admin_prescription_range" %>
        ...
        <div class="row">
            ...
            <asp:Panel ID="formPanel" runat="server" CssClass="col-sm-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        請直接拖曳調整以下排序的順序後按
                        <asp:Button ID="submitButton" runat="server" Text="儲存" CssClass="btn btn-default" OnClick="submitButton_Click" />
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <ol class="example">
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <li num="<%#Eval("num") %>"><%#Eval("pro_name") %></li>
                                    </ItemTemplate>
                                </asp:Repeater>
