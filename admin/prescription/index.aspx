<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Templates/Template001/default.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="admin_prescription_index" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("status") %></td>
                                <td class="hidden-print"><a href="pro_type.aspx?pro_id=<%#Eval("num")%>" class="btn btn-default btn-sm">
