<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Templates/Template001/default.master" AutoEventWireup="true" CodeFile="kind_range.aspx.cs" Inherits="admin_kind_range" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="content_box">
        <div class="row">
            ...
            <div class="col-sm-4 hidden">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <a href="<%=Request.Url.AbsolutePath %>" class="btn btn-default">顯示分類</a>
                    </div>
            ...
            <asp:Panel ID="formPanel" runat="server" CssClass="col-sm-12">

                <asp:HiddenField ID="HiddenField1" runat="server" />

                <div class="panel panel-default">
                    <div class="panel-heading">請直接拖曳調整以下排序的順序後按
                        <asp:Button ID="submitButton" runat="server" Text="儲存" CssClass="btn btn-default" OnClick="submitButton_Click" /></div>
