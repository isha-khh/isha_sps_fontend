<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Templates/Template001/default.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="admin_store_index" %>
        ...
        <div class="search_panel panel panel-default">
            <asp:Panel ID="searchPanel" runat="server" CssClass="panel-body form-horizontal" role="form" DefaultButton="searchButton">
                ...
                <asp:Panel ID="nationPanel" runat="server" CssClass="form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList ID="find1" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="find1_SelectedIndexChanged">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="find1" />
                            </Triggers>
                        </asp:UpdatePanel>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="find6" runat="server" placeholder="序號(可輸入關鍵字查詢)" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">公司行號名稱</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="find3" runat="server" placeholder="公司行號名稱(可輸入關鍵字查詢)" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#store_kind.kindText((int)Eval("kind")) %></td>
                                <td><%#Eval("pro_num")  %></td>
                                <td><%#Eval("pro_name")  %></td>
                                <td><%#Eval("level")  %></td>
                                <td>
                                    <asp:Literal ID="areas" runat="server"></asp:Literal></td>
                                <td><%#Eval("postnumber") %><%# region.getText(Val(Eval("city"))) %><%# region.getText(Val(Eval("area"))) %><%#Eval("address") %></td>
                                <td><%#Eval("status") %></td>
                                <td class="hidden-print">
