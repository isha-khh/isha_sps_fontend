<%@ Control Language="C#" AutoEventWireup="true" CodeFile="sub_news.ascx.cs" Inherits="ext_submenu_sub_news_sub_news" %>
    ...
    <ItemTemplate>
         <li class="dropdown dropend <%#liClassName%>">
            ...
            <asp:Repeater ID="Repeater3" runat="server" OnItemDataBound="Repeater3_ItemDataBound">
                ...
                <ItemTemplate>
                    <li><asp:HyperLink CssClass="dropdown-item" ID="menu" runat="server"></asp:HyperLink></li>
                </ItemTemplate>
                <FooterTemplate>
                    </ul>
                </FooterTemplate>
