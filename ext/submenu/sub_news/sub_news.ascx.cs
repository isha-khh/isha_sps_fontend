...
public partial class ext_submenu_sub_news_sub_news : ez.web.controls.SubNavControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ViewState["SubPage"] = "~/page/news/index.aspx";
            ...
            Repeater2.DataSource = newsKind.RowDataTable(Selroot, nation);
            Repeater2.DataBind();
        }
    }
    protected void Repeater2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType != ListItemType.Header && e.Item.ItemType != ListItemType.Footer)
        {
            ...
            if (Tiers > 2)
            {
                ...
                ViewState["SubPage2"] = "~/page/news/index.aspx";

                DataTable dt = newsKind.RowDataTable(f.Val(row["num"]), nation);
