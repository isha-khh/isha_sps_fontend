...
public partial class ext_submenu_sub_faq_sub_faq : ez.web.controls.SubNavControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ViewState["SubPage"] = "~/page/faq/index.aspx";
            ...
            Repeater2.DataSource = QAKind.RowDataTable(Selroot, nation);
            Repeater2.DataBind();
        }
    }
    protected void Repeater2_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType != ListItemType.Header && e.Item.ItemType != ListItemType.Footer)
        {
            ...
            if (Tiers > 2)
            {
                ...
                ViewState["SubPage2"] = "~/page/faq/index.aspx";

                DataTable dt = QAKind.RowDataTable(f.Val(row["num"]), nation);
                if (dt.Rows.Count > 0)
                {
