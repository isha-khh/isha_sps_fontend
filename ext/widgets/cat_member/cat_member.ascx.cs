...
public partial class wrp_widgets_cat_member : ez.web.controls.ControlBase, MemberPageToUC
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            couponsLi.Visible = coupons.isActive();
            bonus bonus = new bonus();
            bonusLi.Visible = bonus.isActive();
