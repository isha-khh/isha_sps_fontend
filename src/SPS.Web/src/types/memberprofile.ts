import type { MemberPosition } from "@/types/api";
import type {AddressDto, PictureResponse, Status} from "@/types/company";
...
/**
 * 新增公司成員請求介面
 * 對應後端: POST /api/member/company/members
 */
...
/**
 * 更新公司成員請求介面
 * 對應後端: PUT /api/member/company/members/{id}
 */
...
export const CompanyType = {
    /** * 一般公司
     * @description 基礎功能的普通帳號
     */
    General: 0,

    /** * 進階公司
     * @description 享有進階功能或較高配額的帳號
     */
    Premium: 1,

    /** * 企業級公司
     * @description 適用於大型組織，包含完整權限與客製化服務
     */
    Enterprise: 2
} as const;

/** * 公司類型聯集 (Union Type)
 * @typedef {0 | 1 | 2} CompanyType
 */
